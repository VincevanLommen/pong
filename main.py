...
easy_button = Button(WINDOW_WIDTH//2 - button_width//2, start_y, button_width, button_height, "Easy", GREEN)
medium_button = Button(WINDOW_WIDTH//2 - button_width//2, start_y + button_height + spacing, button_width, button_height, "Medium", ORANGE)
hard_button = Button(WINDOW_WIDTH//2 - button_width//2, start_y + 2 * (button_height + spacing), button_width, button_height, "Hard", RED)
...
# Second loop: Ask for the user's name
if level:
    input_active = True
    user_name = ""
    ...
    while input_active:
        ...
        prompt_rect = prompt_surface.get_rect(center=(WINDOW_WIDTH//2, start_y - 50))
